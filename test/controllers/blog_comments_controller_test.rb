...
class BlogCommentsControllerTest < ActionController::TestCase
  ...
  test "should create blog_comment" do
    assert_difference('BlogComment.count') do
      post :create, blog_comment: { blog_entry_id: @blog_comment.blog_entry_id, entry_date: @blog_comment.entry_date, entry_text: @blog_comment.entry_text, user_id: @blog_comment.user_id }
    end
  ...
  test "should update blog_comment" do
    patch :update, id: @blog_comment, blog_comment: { blog_entry_id: @blog_comment.blog_entry_id, entry_date: @blog_comment.entry_date, entry_text: @blog_comment.entry_text, user_id: @blog_comment.user_id }
    assert_redirected_to blog_comment_path(assigns(:blog_comment))
  end
